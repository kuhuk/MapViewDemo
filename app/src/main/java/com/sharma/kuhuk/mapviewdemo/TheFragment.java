 ...
 */
public class TheFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.the_fragment, container, false);
        ...
        adapter = new RecyclerViewDemo(stringArrayList);
        recyclerView.setAdapter(adapter);

        myOnClickListener = new TheFragment.MyOnClickListener(getActivity());
        //RecyclerView code ends here

        return rootView; //For TheFragment
    }
