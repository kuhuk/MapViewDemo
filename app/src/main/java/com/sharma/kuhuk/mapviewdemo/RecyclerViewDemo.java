...
public class RecyclerViewDemo extends RecyclerView.Adapter<RecyclerViewDemo.MyViewHolder> {
    ...
    RecyclerViewDemo(ArrayList<String> strings) {
        arrayList = strings;
        }
...
//        this.mButton = v.findViewById(R.id.btn_paynow);
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.activity_recycler_view_demo, viewGroup, false);

        view.setOnClickListener(TheFragment.myOnClickListener);
